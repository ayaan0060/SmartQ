...
router.patch('/:id', authorize('super-admin', 'hospital-admin', 'doctor'), ctrl.update);
router.patch('/:id/availability', authorize('super-admin', 'hospital-admin', 'doctor'), ctrl.toggleAvailability);
