...
# Serve animated UI at /ui — must be mounted BEFORE the landing page route
from fastapi.staticfiles import StaticFiles
ui_path = os.path.join(os.path.dirname(__file__), "..", "animated-ui")
