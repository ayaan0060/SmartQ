...
def _find_hospitals(lat: float, lng: float, urgency: str) -> dict:
    ...
    for place in results:
        ...
        hospitals.append({
            ...
            "directions_url": f"https://www.openstreetmap.org/directions?from={lat},{lng}&to={h_lat},{h_lng}",
        })
...
async def get_route(
    ...
    return {
        "osm_directions": f"https://www.openstreetmap.org/directions?from={origin_lat},{origin_lng}&to={dest_lat},{dest_lng}",
