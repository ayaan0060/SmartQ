...
URI  = os.getenv("NEO4J_URI",      "neo4j+s://08edbceb.databases.neo4j.io")
AUTH = (os.getenv("NEO4J_USER",    "08edbceb"),
        os.getenv("NEO4J_PASSWORD", "TKoG3evKm2KD9bXK8TwN3NrppyqWyBC1Gn65dhw0U34"))
